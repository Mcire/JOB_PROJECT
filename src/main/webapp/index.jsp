...
<body>
  ...
  <aside id="sidebar" class="sidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href='<c:url value="/auth/login"/>'>
  ...
  <main id="main" class="main">
  	<div class="pagetitle">
     	<h1>Trouver un travail facilement !!</h1>
     		<!-- <nav>
        		<ol class="breadcrumb">
    ...
    <section class="section">
    	<div class="row">
        	<div class="col-lg-6">
          		<div class="card">
            		<div class="card-body">
              			<h5 class="card-title"><a href="index.html">Trouver votre emploi</a></h5>
              			<p>Trouvez votre voie vers le succès avec nous - votre destination de choix pour l'emploi.</p>
            		</div>
          		</div>
        	</div>
	        <div class="col-lg-6">
	        	<div class="card">
	            	<div class="card-body">
	              		<h5 class="card-title"><a href="index.html">Faites votre annonce</a></h5>
	              		<p>Trouvez les talents dont vous avez besoin pour propulser votre entreprise vers de nouveaux sommets.</p>
	           		</div>
	          	</div>
	        </div>
      	</div>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; che guevara <strong><span>JobFind</span></strong>. Tous les droits sont réservés
    </div>
    <!-- <div class="credits">
