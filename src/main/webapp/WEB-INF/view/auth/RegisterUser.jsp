              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Entrez vos informations personnelles pour créer votre cv</p>
                  </div>
                  ...
                  <form  method="post" class="row g-3 needs-validation" novalidate>
	                ...
	                <div class="row">
	                    <div class="col-6">
	                      ...
	                      <div class="invalid-feedback">SVP, entrez votre age</div>
	                    </div>
	                    <div class="col-6">
	                ...
	                <div class="row">
	                    <div class="col-6">
	                      ...
	                      <input type="text" name="niveauEtude" class="form-control" id="NiveauEtude" required>
	                      <div class="invalid-feedback">SVP, entrez votre niveau d'etude</div>
	                    </div>
	                    <div class="col-6">
	                      ...
	                      <div class="invalid-feedback">SVP, donner votre specialité</div>
	                    </div>
	                </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="experienceProfessionnelle" class="form-label">Experience Professionnelle</label>
                      <textarea name="experienceProfessionnelle" class="form-control" id="experienceProfessionnelle" required></textarea>
                      <div class="invalid-feedback">svp, donnez votre experience professionnelle</div>
                    </div>
                    <div class="col-12">
